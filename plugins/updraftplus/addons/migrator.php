...
// 	}
	...
	private function process_row($table, $row, $search, $replace, $stripped_table) {
		...
		foreach ($this->columns as $column => $primary_key) {
			...
			if (('options' == $stripped_table && 'option_value' == $column && $row['option_name'] == 'updraft_remotesites') || ('sitemeta' == $stripped_table && 'meta_value' == $column && 'updraftplus_options' == $row['option_name'])) {
				continue;
			}
